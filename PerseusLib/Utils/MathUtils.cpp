...
void MathUtils::SquareMatrixProduct(float *c, const float *a, const float *b, int dim)
{
	int i, j, k;
...
{
	float det = det=a[0][0]*(a[1][1]*a[2][2]-a[2][1]*a[1][2])-a[0][1]*(a[1][0]*a[2][2]-a[1][2]*a[2][0])+a[0][2]*(a[1][0]*a[2][1]-a[1][1]*a[2][0]);
